"""
Django settings for wikidialisis project.
...
SECRET_KEY = 'django-insecure-n%bds0hodp2g&dv_bcs!xvzecmzjg*qxvkb7k9iw9^^y&j#sl#'
...
WSGI_APPLICATION = 'wikidialisis.wsgi.application'
